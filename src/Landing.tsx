...
export default function LandingPage() {
    ...
    return (
      <div className="min-h-screen bg-background">
              ...
              <div className="relative mx-auto z-20 flex max-w-7xl flex-col px-6 lg:block lg:px-12">
                ...
                <div className="mx-auto max-w-lg text-center lg:ml-0 lg:max-w-full lg:text-left">
                  ...
                  <p className="mt-8 max-w-2xl text-balance text-lg">
                    Revolutionary AI-powered organ donor matching system that
                    increases transplant success rates through advanced HLA
              ...
              <div className="flex flex-col items-center md:flex-row ">
                <div className="md:max-w-44 md:border-r md:pr-6">
                  <p className="text-end text-sm">
                    Trusted by leading hospitals (demo)
                  </p>
                </div>
        ...
        <section
          id="features"
          className="pt-30 lg:pt-50 md:pt-10 w-full max-w-7xl mx-auto px-4"
        >
          <div className="container mx-auto px-4">
            <div className="text-center mb-16">
              ...
              <h2 className="text-3xl lg:text-4xl font-bold mb-4">
                Cutting-Edge Features for Medical Excellence
              </h2>
              <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
                Our comprehensive platform combines advanced DNA analysis with
                AI-powered insights to deliver unparalleled accuracy in organ
                matching.
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              {features.map((feature, index) => (
                <Card
                  key={index}
                  className="p-6  rounded-xl border-dashed border-2 transition-all shadow-none"
                >
              ...
              <div className="flex flex-col sm:flex-row gap-8">
                ...
                <div className="w-full sm:w-1/2 flex flex-col justify-center">
                  ...
                  <p className="text-xl text-muted-foreground">
                    Join hundreds of medical institutions already using BioMatch
                    to improve transplant success rates and save more lives.
                  </p>
                </div>
          ...
          <div className="container mx-auto px-4 text-center bg-primary-foreground rounded-3xl p-12 w-full max-w-7xl">
            <div className="max-w-3xl mx-auto space-y-8">
              <h2 className="text-3xl lg:text-4xl font-bold">
                Ready to Transform Your Organ Matching Process?
              </h2>
              <p className="text-xl opacity-90">
                Join leading medical institutions using BioMatch to save more
                lives through precision DNA matching.
              </p>
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                ...
                <a
                  href="https://github.com/mohammedsbd/BioMatch"
                  target="_blank"
                >
                  <Button
                    size="lg"
